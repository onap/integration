...
Then deploy ONAP with Helm (assumed being in OOM repo kubernetes directory) with your 2 override files.

::

    helm deploy onap ./onap --namespace onap -f ~/onap-selected.yaml -f ~/override.yaml
