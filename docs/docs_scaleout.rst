...
- CDS blueprint: https://git.onap.org/integration/tree/docs/files/scaleout/CBA-enriched.zip
- Data dictionary: https://git.onap.org/integration/tree/docs/files/scaleout/dd.zip
...
Please look at the CDS documentation for details about how to create configuration models, blueprints, and use the CDS tool: https://wiki.onap.org/display/DW/Modeling+Concepts. For running the use case, users can use the standard model package that CDS provides out of the box, which can be found at the top of the page.
