...
::
    ...
    python3 workflow.py <VNF-ID> <RANCHER-NODE-IP> <K8S_NODE_IP> <IF-CACHE> <IF-VFWCL> <INITIAL-ONLY> <CHECK-STATUS> <VERSION>
...
::
    ...
    python3 workflow.py <VNF-ID> <RANCHER-NODE-IP> <K8S_NODE_IP> True False True True 2.0
