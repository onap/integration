...
Kohn release also fixed a few critical bugs in Jakarta release and completed the carry-over tests from Jakarta release.

Impacted Modules for Kohn Release
------------------------------------
- **SO**: Requirements below for Kohn release have impacts on SO component:
     (1) Bug fixes for carryover test cases from Jakarta release
...
- **CCSDK/SDN-C**: Requirements below for Kohn release have impacts on CCSDK/SDN-C component
     (1) Bug fixes of carryover test cases from Jakarta release
