...
USER_PUBLIC_IP_PREFIX=     Space delimited list of ip addresses that will be added to azure secuirty groups for access. If you need to access the ONAP portal, or DevStack, then add your public ip address or CIDR here.
