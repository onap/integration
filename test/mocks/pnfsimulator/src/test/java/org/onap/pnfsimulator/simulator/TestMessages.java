...
final class TestMessages {
    ...
    static final JSONObject VALID_PNF_REGISTRATION_PARAMS = new JSONObject(getContent("validPnfRegistrationParams.json"));
    static final JSONObject VALID_NOTIFICATION_PARAMS = new JSONObject(getContent("validNotificationParams.json"));
    ...
    static final JSONObject INVALID_PNF_REGISTRATION_PARAMS_1 = new JSONObject(
            "{\n" +
    ...
    static final JSONObject INVALID_PNF_REGISTRATION_PARAMS_2 = new JSONObject(
            "{\n" +
                    "    \"pnfVendorName\": \"val2\",\n" +
    ...
    static final JSONObject INVALID_PNF_REGISTRATION_PARAMS_3 = new JSONObject(
            "{\n" +
                    "    \"pnfSerialNumber\": \"val1\",\n" +
                    "    \"pnfOamIpv4Address\": \"val3\",\n" +
                    "    \"pnfFamily\": \"val5\",\n" +
    ...
    private static String getContent(String fileName) {
        try {
            ...
            Files.readAllLines(Paths.get(pathAsString)).forEach(stringBuilder::append);
