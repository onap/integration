...
final class TestMessages {
    ...
    static final JSONObject VALID_COMMON_EVENT_HEADER_PARAMS = new JSONObject(
        getContent("validCommonEventHeaderParams.json"));
    static final Optional<JSONObject> VALID_PNF_REGISTRATION_PARAMS = Optional
        .ofNullable(new JSONObject(getContent("validPnfRegistrationParams.json")));
    ...
    static final Optional<JSONObject> INVALID_PNF_REGISTRATION_PARAMS_1 = Optional.ofNullable(new JSONObject(
        "{\n" +
    ...
    static final Optional<JSONObject> INVALID_PNF_REGISTRATION_PARAMS_2 = Optional.ofNullable(new JSONObject(
        "{\n" +
            "    \"pnfVendorName\": \"val2\",\n" +
    ...
    static final Optional<JSONObject> INVALID_PNF_REGISTRATION_PARAMS_3 = Optional.ofNullable(new JSONObject(
        "{\n" +
            "    \"pnfSerialNumber\": \"val1\",\n" +
            "    \"pnfOamIpv4Address\": \"val3\",\n" +
            "    \"pnfFamily\": \"val5\",\n" +
    ...
    static final Optional<JSONObject> INVALID_NOTIFICATION_PARAMS = Optional.ofNullable(new JSONObject(
        "{\n" +
            "    \"pnfSerialNumber\": \"val1\",\n" +
            "    \"mother\": \"val3\",\n" +
            "    \"pnfFamily\": \"val5\",\n" +
