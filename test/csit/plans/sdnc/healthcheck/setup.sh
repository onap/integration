...
docker pull $NEXUS_DOCKER_REPO/onap/sdnc-ueblistener-image:$DOCKER_IMAGE_VERSION
docker tag $NEXUS_DOCKER_REPO/onap/sdnc-ueblistener-image:$DOCKER_IMAGE_VERSION onap/sdnc-ueblistener-image:latest
