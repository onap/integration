...
${WORKSPACE}/test/csit/scripts/so/hpa/generic_sim/generic_sim_build.sh ${WORKSPACE}/test/csit/scripts/so/hpa/generic_sim/
${WORKSPACE}/test/csit/scripts/so/hpa/generic_sim/generic_sim_run.sh
${WORKSPACE}/test/csit/scripts/so/hpa/hpa_script.sh
