...
pwd
echo ${WORKSPACE}
/w/workspace/so-master-verify-csit-hpa/test/csit/plans/so/hpa/generic_sim/generic_sim_build.sh
/w/workspace/so-master-verify-csit-hpa/test/csit/plans/so/hpa/generic_sim/generic_sim_run.sh
/w/workspace/so-master-verify-csit-hpa/test/csit/plans/so/hpa/hpa_script.sh
