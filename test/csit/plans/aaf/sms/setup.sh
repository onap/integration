...
#docker pull nexus3.onap.org:10003/onap/aaf/sms
...
docker run --workdir /sms -v "$(pwd)"/config/smsconfig.json:/sms/smsconfig.json \
           --name sms -d -p 10443:10443 nexus3.onap.org:10003/onap/aaf/sms
...
ROBOT_VARIABLES="-v SMS_HOSTNAME:https://localhost -v SMS_PORT:10443"
