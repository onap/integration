...
git pull
cd $WORKSPACE/archives/aafcsit/aaf/authz/authz-service/src/main/resources/docker-compose
cp $WORKSPACE/archives/aafcsit/aaf/authz/authz-service/src/main/resources/docker-compose/data /var/tmp/
...
echo DMAAP_MR_IP=${AAF_IP}
echo KAFKA_IP=${CASSANDRA_IP}
