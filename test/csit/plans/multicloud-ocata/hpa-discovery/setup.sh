...
./run-instance.sh nexus3.onap.org:10003/onap/multicloud/openstack-ocata multicloud-ocata "-t -e MSB_ADDR=localhost -e MSB_PORT=$nova_port -e AAI_ADDR=localhost -p 9006:9006"
