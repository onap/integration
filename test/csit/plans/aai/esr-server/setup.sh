...
# Start esrserver
docker run -d --name esrserver --env msbDiscoveryIp=${DISCOVERY_IP} -env msbDiscoveryPort=10081 nexus3.onap.org:10001/onap/aai/esr-server
#source ${SCRIPTS}/aai/esr-server/startup.sh i-esrserver ${MSB_IP} 80
ESRSERVER_IP=`get-instance-ip.sh i-esrserver`
