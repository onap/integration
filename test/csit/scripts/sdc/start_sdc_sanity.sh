...
#  PID=`docker exec -it sdc-sanity ps -ef | grep java | awk '{print $2}'`; echo sanity PID is -- $PID
...
cp -rf ${WORKSPACE}/data/logs/sdc-sanity/ExtentReport/SDC_CI_Extent_Report.html ${WORKSPACE}/data/archives/
