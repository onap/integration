...
Library    eteutils/ExtendedSelenium2Library
Library    eteutils/OperatingSystem
Library	          eteutils/RequestsClientCert
Library 	      eteutils/RequestsLibrary
Library	          eteutils/UUID 
Library         eteutils/DateTime  
Library           eteutils/Collections
Library           eteutils/OSUtils
...
${PORTAL_HEALTH_CHECK_PATH}        http://portal.api.simpledemo.openecomp.org:8989/ECOMPPORTAL/portalApi/healthCheck
${PORTAL_ASSETS_DIRECTORY}    $WORKSPACE\directory_where_he_store_json_file\
