...
${COMPLEXURL}              https://${HOST_IP}:8443/v11/cloud-infrastructure/complexes/complex/${COMPLEXKEYVALUE}
${PSERVERURL}              https://${HOST_IP}:8443/v11/cloud-infrastructure/pservers/pserver/${PSERVERKEYVALUE}
${PSERVERRELATIONSHIPURL}  https://${HOST_IP}:8443/v11/cloud-infrastructure/pservers/pserver/${PSERVERKEYVALUE}/relationship-list/relationship}
