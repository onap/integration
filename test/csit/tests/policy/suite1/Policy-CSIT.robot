...
${CREATE_OPS_VCPE_TEMPLATE}      /testsuite/robot/assets/templates/opspolicy_vCPE.template  

${CRETAE_CONFIG_VDNS_POLICY}    robot/assets/templates/configpolicy_vDNS.template
