*** Settings ***
Documentation	  Testing Data File Collector with File Ready event feed from xNF
...
${EVENT_DATA_FILE}                       %{WORKSPACE}/test/csit/tests/dcaegen2-collectors-datafile/testcases/assets/json_events/FileExistNotification.json
