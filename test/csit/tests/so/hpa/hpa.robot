...
*** Variables ***
${CREATESERVICEJSON}=    Get Binary File     ${CURDIR}${/}data${/}createVcpeServiceInstance.json
...
Create ServiceInstance for vcpe
    ...
    ${resp}=    Post Request    refrepo    /ecomp/mso/infra/serviceInstances/v3    data=${CREATESERVICEJSON}    headers=${HEADERS}
